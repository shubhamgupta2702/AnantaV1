...
function Cardcolor() {
  return (
    <>
      <div className="min-h-screen bg-black flex flex-col justify-center relative overflow-hidden sm:py-12">
    ...
    <div className="relative group">
      ...
      <div className="relative px-7 py-6 bg-black ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
        <div className="col-span-1 md:col-span-8">
          <h1 className='mb-4 text-xl text-white md:text-2xl text-center font-circular-web'>Ananta Tech Fest - 2025</h1>
